/**
 * IGRIS Business Pulse — survey question bank.
 * Single source of truth, consumed by js/survey.js (to render the
 * survey) and js/admin.js (to label response fields consistently).
 *
 * type: "single"  -> one choice, options[]
 *       "text"     -> open text, textarea
 *       "yesno"    -> yes/no, second one reveals a follow-up field
 */
const QUESTIONS = [
  {
    id: "businessType",
